...
DATABASES = {
    'default': {
        ...
        'NAME': '/home4/sophiech/dev/dev.db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    '/home/sophiech/dev/public/static/',
)
...
SECRET_KEY = 'di8-^8g0nn@yz$%b3%y*$huf9(c-226%m-#y36di6b)=zux(i)'
